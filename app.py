...
def prediction():
    ...
    stocks = pd.read_csv('Output2.csv')
...
###################################################################################################################################################
    ...
    todays_date = date.today().ctime()
    st.subheader('The Estimated Closing price for '+todays_date+' :')
...
def recom():
    ...
    newsapi = NewsApiClient(api_key='9061a6af91aa4a71957e4b268e6cd6c1') 
    input_country = 'India'
